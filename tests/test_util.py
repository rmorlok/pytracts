...
class ModuleInterfaceTest(object):
    ...
    def test_no_exported_protected_variables(self):
    ...
    def test_no_exported_modules(self):
...
class OptionalMessage(messages.Message):
    ...
    # sint32_value = messages.IntegerField(variant=messages.Variant.SINT32)
    # sint64_value = messages.IntegerField(variant=messages.Variant.SINT64)
